...
# for idx in tqdm(range(10), desc="Assigning Biodomains testing"):
...
From the list of Biodomains, choose the **top 5** labels that best fit this term—ranked most-to-least appropriate.
 and return **exactly five** domain names, **without** numbering or bullets.
            ...
            messages=[
                {
                    ...
                    "content": (
                        "You are a biomedical ontology expert. "
                        "Always return exactly five ranked Biodomains"
                    )
                },
...
# df_go.to_csv("result/biodomain_results_top5_with_similarity_demo_unknown.csv", index=False)
df_go.to_csv("result/biodomain_results_top5_with_similarity_unknown.csv", index=False)