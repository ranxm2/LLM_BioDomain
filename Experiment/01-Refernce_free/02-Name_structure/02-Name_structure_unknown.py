...
# for go_index in tqdm(range(10), desc="Assigning Biodomains testing"):
    go_term = df_go.iloc[go_index]['node']
    go_id   = df_go.iloc[go_index]['nodeID']
...
# Save results
# df_go.to_csv("result/biodomain_results_top5_with_structure_demo_unknown.csv", index=False)
df_go.to_csv("result/biodomain_results_top5_with_structure_unknown.csv", index=False)
