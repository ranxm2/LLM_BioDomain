...
#SBATCH --output=../logs/Ref_Free_FXS_N_O_unknwon_%A_%a_out.txt
#SBATCH --error=../logs/Ref_Free_FXS_N_O_unknwon_%A_%a_err.txt
#SBATCH --array=1
#SBATCH --ntasks=1
...
python ./source/chatgpt/chatgpt_biodomain_FXS_Name_OBO_unknown_v2.py \
  ...
  --result_dir Experiment/ChatGPT/01-Ref-Free/02-Name-OBO/Unknown_0.0 \
