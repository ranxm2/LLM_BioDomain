...
#SBATCH --output=../logs/AD_%A_%a_out.txt
#SBATCH --error=../logs/AD_%A_%a_err.txt
#SBATCH --array=1-4
#SBATCH --ntasks=1
...
python ./source/chatgpt/chatgpt_biodomain_AD_temp.py \
  ...
  --result_dir Experiment/ChatGPT/02-AD/Temp_${TEMP} \
