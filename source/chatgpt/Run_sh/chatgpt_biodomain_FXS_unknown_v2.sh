#!/bin/bash
#SBATCH --job-name=ChatGPT_FXS_unknown
#SBATCH --output=../logs/FXS_unknown_%A_%a_out.txt
#SBATCH --error=../logs/FXS_unknown_%A_%a_err.txt
#SBATCH --array=1
#SBATCH --ntasks=1
...
python ./source/chatgpt/chatgpt_biodomain_FXS_unknown_v2.py \
  ...
  --result_dir Experiment/ChatGPT/03-FXS_v2/Unknown_Temp_${TEMP} \
