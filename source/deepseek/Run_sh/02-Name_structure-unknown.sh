...
#SBATCH --output=../logs/ref-free-Name-structure-unknown-%A_%a_out.txt
#SBATCH --error=../logs/ref-free-Name-structure-unknown-%A_%a_err.txt
#SBATCH --array=1-20
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_structure_unknown.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/02-Name_structure/Unknown_0 \
