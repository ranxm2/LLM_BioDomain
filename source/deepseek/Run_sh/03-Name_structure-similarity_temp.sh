...
#SBATCH --output=../logs/ref-free-Name-structure-similarity-temp-%A_%a_out.txt
#SBATCH --error=../logs/ref-free-Name-structure-similarity-temp-%A_%a_err.txt
#SBATCH --array=1-160
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_structure_similarity_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/03-Name_structure_similarity/Temp_${TEMP} \
