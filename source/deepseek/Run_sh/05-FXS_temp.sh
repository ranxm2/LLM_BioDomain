#!/bin/bash
#SBATCH --job-name=DS_FXS_temp
#SBATCH --output=../logs/FXS-temp-%A_%a_out.txt
#SBATCH --error=../logs/FXS-temp-%A_%a_err.txt
#SBATCH --array=1-160
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_FXS_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/05-FXS/Temp_${TEMP} \
