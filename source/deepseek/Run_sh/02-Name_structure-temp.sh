...
#SBATCH --output=../logs/ref-free-Name-structure-temp-%A_%a_out.txt
#SBATCH --error=../logs/ref-free-Name-structure-temp-%A_%a_err.txt
#SBATCH --array=1-60
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_structure_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/02-Name_structure/Temp_${TEMP} \
