...
#SBATCH --output=../logs/FXS-unknown-%A_%a_out.txt
#SBATCH --error=../logs/FXS-unknown-%A_%a_err.txt
#SBATCH --array=1-40
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_FXS_unknown_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/05-FXS/Unknown_Temp_${TEMP} \
