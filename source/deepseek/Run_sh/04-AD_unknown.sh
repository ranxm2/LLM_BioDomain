#!/bin/bash
#SBATCH --job-name=DS_AD_unknown
#SBATCH --output=../logs/AD-unknown-%A_%a_out.txt
#SBATCH --error=../logs/AD-unknown-%A_%a_err.txt
#SBATCH --array=1-40
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_AD_unknown_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/04-AD_temp/Unknown_Temp_${TEMP} \
