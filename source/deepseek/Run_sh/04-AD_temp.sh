#!/bin/bash
#SBATCH --job-name=DS_AD_temp
#SBATCH --output=../logs/AD-temp-%A_%a_out.txt
#SBATCH --error=../logs/AD-temp-%A_%a_err.txt
#SBATCH --array=1-160
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_AD_temp.py \
  ...
  --result_dir Experiment/DeepSeek/01-Reference_free/04-AD_temp/Temp_${TEMP} \
