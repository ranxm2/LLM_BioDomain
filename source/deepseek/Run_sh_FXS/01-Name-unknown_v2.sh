#!/bin/bash
#SBATCH --job-name=BD_N_Unknown
#SBATCH --output=../logs_FXS/01-Name/ref-free-Name-unknown-%A_%a_out.txt
#SBATCH --error=../logs_FXS/01-Name/ref-free-Name-unknown-%A_%a_err.txt
#SBATCH --array=1-12
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_unknown_v2.py \
  ...
  --result_dir Experiment/DeepSeek/02-FXS/01-Name/Unknown_0 \
