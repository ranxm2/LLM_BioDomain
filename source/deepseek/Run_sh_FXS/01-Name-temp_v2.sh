...
#SBATCH --output=../logs_FXS/01-Name/ref-free-Name-temp-%A_%a_out.txt
#SBATCH --error=../logs_FXS/01-Name/ref-free-Name-temp-%A_%a_err.txt
#SBATCH --array=1-48
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_temp_v2.py \
  ...
  --result_dir Experiment/DeepSeek/02-FXS/01-Name/Temp_${TEMP} \
