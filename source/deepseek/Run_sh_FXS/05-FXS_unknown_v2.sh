#!/bin/bash
#SBATCH --job-name=DS_FXS_unknown
#SBATCH --output=../logs_FXS/04-FXS/FXS-unknown-%A_%a_out.txt
#SBATCH --error=../logs_FXS/04-FXS/FXS-unknown-%A_%a_err.txt
#SBATCH --array=1-11
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_FXS_unknown_temp_v2.py \
  ...
  --result_dir EExperiment/DeepSeek/02-FXS/04-FXS/Unknown_Temp_${TEMP} \
