#!/bin/bash
#SBATCH --job-name=BD_N_O_temp
#SBATCH --output=../logs_FXS/02-Name-structure/Temp-%A_%a_out.txt
#SBATCH --error=../logs_FXS/02-Name-structure/Temp-%A_%a_err.txt
#SBATCH --array=1-48
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_structure_temp_v2.py \
  ...
  --result_dir Experiment/DeepSeek/02-FXS/02-Name_structure/Temp_${TEMP} \
