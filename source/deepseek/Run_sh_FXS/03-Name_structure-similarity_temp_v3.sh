#!/bin/bash
#SBATCH --job-name=DS_N_O_S_temp
#SBATCH --output=../logs_FXS/03-Name-structure-similarity/FXS-temp-%A_%a_out.txt
#SBATCH --error=../logs_FXS/03-Name-structure-similarity/FXS-temp-%A_%a_err.txt
#SBATCH --array=1-12
#SBATCH --ntasks=1
...
python ./source/deepseek/deepseek_biodomain_name_structure_similarity_temp_v2.py \
