...
#SBATCH --output=../logs_FXS/03-Name-structure-similarity/ref-free-Name-structure-similarity-unknown-%A_%a_out.txt
#SBATCH --error=../logs_FXS/03-Name-structure-similarity/ref-free-Name-structure-similarity-unknown-%A_%a_err.txt
#SBATCH --array=1-12
#SBATCH --array=1-12
#SBATCH --ntasks=1
...
# cd /projects/compbio/users/xran2/wen/JX/02-AI-BioDomain/git_folder/source/deepseek/Run_sh_FXS
...
python ./source/deepseek/deepseek_biodomain_name_structure_similarity_unknown_v2.py \
