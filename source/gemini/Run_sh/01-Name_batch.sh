#!/bin/bash
#SBATCH --job-name=Gemini-Name
#SBATCH --output=../logs/ref-free-Name-%A_%a_out.txt
#SBATCH --error=../logs/ref-free-Name-%A_%a_err.txt
#SBATCH --array=1-4
#SBATCH --ntasks=1
...
python ./source/gemini/gemini_biodomain_name_temp_batch.py \
  ...
  --result_dir        Experiment/Gemini/01-Reference_free/01-Name/Temp_${TEMP} \
