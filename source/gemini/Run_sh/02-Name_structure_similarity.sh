...
python ./source/gemini/gemini_biodomain_name_structure_similarity_temp.py \
    ...
    --result_dir Experiment/Gemini/01-Reference_free/03-Name_structure_similarity/Temp_${TEMP} \
