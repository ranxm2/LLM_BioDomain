...
def assign_biodomains(df_go,df_sim, graph, client, result_dir, temperature=0.0,batch_size=1000, array_index=1):
...
"""
    ...
    output_path = os.path.join(result_dir, f"go_biodomain_results.csv")
